...
void main() {
  ...
  testWidgets(
    'renders EmailAuthForm and SocialSignInButtons when state is guest',
  ...
  testWidgets(
    'renders user session info and sign out button when state is authenticated',
    (WidgetTester tester) async {
      ...
      when(
        () => mockAuthBloc.state,
      ).thenReturn(const AuthState.authenticated(tSession));
  ...
  testWidgets(
    'dispatches social provider event when tapping Google button',
    (WidgetTester tester) async {
      stubGuestState();
  ...
  testWidgets(
    'hides Apple sign-in on Android',
    (WidgetTester tester) async {
      stubGuestState();
