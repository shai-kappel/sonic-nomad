...
void main() {
  group('Phase 03 Nyquist Validation:', () {
    group('1. MusicBrainz API Client & Rate Limiting:', () {
      test('musicbrainz_api.dart should exist and have rate limiting and User-Agent configured', () {
        final file = File('lib/features/musicbrainz/data/datasources/musicbrainz_api.dart');
    ...
    group('2. Clean Architecture Layer Separation:', () {
      ...
      test('MusicBrainzRepository should be abstract/interface in domain', () {
        final file = File('lib/features/musicbrainz/domain/repositories/musicbrainz_repository.dart');
        expect(file.existsSync(), isTrue);
      ...
      test('MusicBrainzRepositoryImpl should exist in data layer and implement domain interface', () {
        final file = File('lib/features/musicbrainz/data/repositories/musicbrainz_repository_impl.dart');
        expect(file.existsSync(), isTrue);
    ...
    group('3. Data Models vs Domain Entities Boundary:', () {
      test('MBArtistModel and MBRelationModel should have toEntity() methods', () {
        final artistModelFile = File('lib/features/musicbrainz/data/models/mb_artist_model.dart');
        final relationModelFile = File('lib/features/musicbrainz/data/models/mb_relation_model.dart');
      ...
      test('Artist and ArtistRelation entities should not contain serialization logic', () {
        final artistEntityFile = File('lib/features/musicbrainz/domain/entities/artist.dart');
